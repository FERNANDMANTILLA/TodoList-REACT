...
export const Page = ({type,todos,handleNewTodo,handleDeleteTodo,handleToggleToDo}) => {
  ...
  return (
    <>
    <h1 className="text-center d-flex  flex-column">{type} ({todos.length}) <small className="text-danger shadow-text">({toBeDone()}) TODOS to be done</small></h1>
